...
const Page = async ({ params }: { params: { quesId: string; quesName: string } }) => {
    ...
    const preview = await storage.getFilePreview(questionAttachmentBucket, question.attachmentId);
    // console.log("File Preview:", preview); // Make sure this returns the correct data
